...
# print(get_schema_tool.invoke("customer_feedback"))
...
# print(db_query_tool.invoke("SELECT * FROM customer_feedback LIMIT 10;"))
...
#     {"messages": [("user", "Which customer gave the most feedback")]}
# ):
# print(event)
...
async def process_query(request: QueryRequest):
    """Process natural language query and return results with visualization"""
    try:
        # Return response
        event1 = ""
